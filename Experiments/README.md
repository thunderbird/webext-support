...
| [Runtime.onDisable] | [@rsjtdrjgfuzkfg](https://github.com/rsjtdrjgfuzkfg/) | Permit WebExtensions to perform (time-limited) cleanup tasks after the add-on is disabled or uninstalled. |
