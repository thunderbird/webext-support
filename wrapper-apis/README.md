...
| API             | Description |
| --------------- | ----------- |
| [BootstrapLoader](https://github.com/thundernest/addon-developer-support/wiki/Using-the-BootstrapLoader-API-to-convert-a-Legacy-Bootstrap-WebExtension-into-a-MailExtension-for-Thunderbird-78)      |  Update a Legacy Bootstrap WebExtension
